...
// module.exports = {
//   data: new SlashCommandBuilder().setName('serverinfo').setDescription('This gets some server info'),
...
//       .addFields({ name: 'Date Created', value: `<t:${Number.parseInt(guild.createdTimestamp / 1000)}:R>`, inline: true })
//       .addFields({ name: 'Joined', value: `<t:${Number.parseInt(joinedAt / 1000)}:R>`, inline: true })
